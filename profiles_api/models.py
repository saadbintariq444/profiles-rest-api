...
class Message(models.Model):
    ...
    sender = models.ForeignKey('UserProfile', related_name='fk_message_sender',on_delete='')
    recipient = models.ForeignKey('UserProfile', related_name='fk_message_recipient', on_delete='')
